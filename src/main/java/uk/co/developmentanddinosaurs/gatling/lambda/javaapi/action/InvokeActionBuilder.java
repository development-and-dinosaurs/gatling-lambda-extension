...
public class InvokeActionBuilder implements ActionBuilder {
    ...
    public InvokeActionBuilder(uk.co.developmentanddinosaurs.gatling.lambda.action.InvokeActionBuilder wrapped) {
    ...
    public InvokeActionBuilder requestName(String requestName) {
        return new InvokeActionBuilder(wrapped.requestName(Expressions.toStringExpression(requestName)));
    }
